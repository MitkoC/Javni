...
public class ListRSSItemsActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnAddSite = (ImageButton) findViewById(R.id.dodadilink);
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent in = new Intent(getApplicationContext(), WebPageActivity.class);
	...
	class loadRSSFeedItems extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			pDialog.setMessage("Вчитување на најнови ажурирања...");
